...
rw1 = sooo
rw2=addrjump(rw1,0xa2488)+0x10
rw3=addrjump(rw2,0)+0x30
rw4=addrjump(rw3,0)+0x28c
rwdz=rw4
...
mrrw=sddz + 0x2432A8 ---原地任务>>>   107,374,182,400;25D;4,294,967,296;1D::17从1D转找到有1~288D的1D地址
...
smlzaddr=rwdz+0xA0E4-0x870--睡眠粒子>>> ✓10.19 --CA内存改D类型 1改257D  待找
...
uncloset = so + 0x4C1084--全衣柜446629856改1384120352d 10.19 可隐形斗
