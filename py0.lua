...
ydgypy = sddz + 0x1b581c8 + 0x1acdc + 0x1acdc---原地光翼>>> ✓  :l_CandleSpace_0 往前两个
dengjiaddr = rwdz - 0x22946--光翼数量>>> ✓
mrrw=sddz + 0x246528 + 0xf000 ---原地任务>>>   107,374,182,400;25D;4,294,967,296;1D::17从1D转找到有1~288D的1D地址
...
uncloset = so + 0x437ed8--全衣柜446629856改1384120352d 10.19 可隐形斗
